...
--  tk	string	登陆token，该token为登陆服务器返回的一个唯一字串，代表用户已经登陆成功，可进入游戏
	["User.login"]={uid="cxm100",pid="2001",sid="s2",ut=0,tk="tk00000012"}, --纪念嗑药满级
	--["User.login"]={uid="wudaa11",pid="2001",sid="s2",ut=0,tk="tk00000012"},--william  
	--["User.login"]={uid="faust19",pid="2001",sid="s2",ut=0,tk="tk00000012"},--terry         	          	
...
<<<<<<< .mine
	["User.login"]={uid="2",pid="Thread-1-t",sid="q1",ut=0,tk="tk00000012"},
=======
...
function NetInit()
	if Config.debug then
		...
		local url = string.format("http://%s:8989",ip)
