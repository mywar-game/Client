...
PackAction_storehouseInOrOutRes = {}

--仓库存入或者取出
function PackAction_storehouseInOrOutRes:New(o)
    o = o or {}
    setmetatable(o,self)
    self.__index = self
	self:init()
...
function PackAction_storehouseInOrOutRes:init()
...
function PackAction_storehouseInOrOutRes:getActName()
	return self.actName
end

--类型1存入仓库0取出
function PackAction_storehouseInOrOutRes:setInt_type(int_type)
	self.int_type = int_type
end
--道具类型
function PackAction_storehouseInOrOutRes:setInt_toolType(int_toolType)
	self.int_toolType = int_toolType
end
--道具id
function PackAction_storehouseInOrOutRes:setInt_toolId(int_toolId)
	self.int_toolId = int_toolId
end
--道具数量
function PackAction_storehouseInOrOutRes:setInt_toolNum(int_toolNum)
	self.int_toolNum = int_toolNum
end
--用户装备id
function PackAction_storehouseInOrOutRes:setString_userEquipId(string_userEquipId)
	self.string_userEquipId = string_userEquipId
end
--用户宝石id
function PackAction_storehouseInOrOutRes:setString_userGemstoneId(string_userGemstoneId)
...
function PackAction_storehouseInOrOutRes:encode(outputStream)
...
function PackAction_storehouseInOrOutRes:decode(inputStream)
	    local body = {}
