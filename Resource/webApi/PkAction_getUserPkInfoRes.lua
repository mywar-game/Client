...
PkAction_getUserPkInfoRes = {}

--获取用户竞技场信息
function PkAction_getUserPkInfoRes:New(o)
    o = o or {}
    setmetatable(o,self)
    self.__index = self
	self:init()
...
function PkAction_getUserPkInfoRes:init()
...
function PkAction_getUserPkInfoRes:getActName()
	return self.actName
end

--用户竞技场信息
function PkAction_getUserPkInfoRes:setUserPkInfoBO_userPkInfoBO(UserPkInfoBO_userPkInfoBO)
	self.UserPkInfoBO_userPkInfoBO = UserPkInfoBO_userPkInfoBO
end
--用户防守阵容列表
function PkAction_getUserPkInfoRes:setList_userDefenceHeroList(list_userDefenceHeroList)
	self.list_userDefenceHeroList = list_userDefenceHeroList
end
--用户可挑战列表
function PkAction_getUserPkInfoRes:setList_userPkList(list_userPkList)
...
function PkAction_getUserPkInfoRes:encode(outputStream)
...
function PkAction_getUserPkInfoRes:decode(inputStream)
	    local body = {}
