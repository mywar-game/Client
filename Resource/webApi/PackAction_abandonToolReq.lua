...
PackAction_abandonToolReq = {}

--背包丢弃道具
function PackAction_abandonToolReq:New(o)
    o = o or {}
    setmetatable(o,self)
    self.__index = self
	self:init()
...
function PackAction_abandonToolReq:init()
...
function PackAction_abandonToolReq:getActName()
	return self.actName
end

--道具类型
function PackAction_abandonToolReq:setInt_toolType(int_toolType)
	self.int_toolType = int_toolType
end
--道具id
function PackAction_abandonToolReq:setInt_toolId(int_toolId)
	self.int_toolId = int_toolId
end
--道具数量
function PackAction_abandonToolReq:setInt_toolNum(int_toolNum)
	self.int_toolNum = int_toolNum
end
--用户装备id
function PackAction_abandonToolReq:setString_userEquipId(string_userEquipId)
	self.string_userEquipId = string_userEquipId
end
--用户宝石id
function PackAction_abandonToolReq:setString_userGemstoneId(string_userGemstoneId)
...
function PackAction_abandonToolReq:encode(outputStream)
...
function PackAction_abandonToolReq:decode(inputStream)
	    local body = {}
